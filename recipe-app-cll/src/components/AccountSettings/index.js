...
export class ModalExample extends React.Component {
  ...
  render() {
    return (
      <div>
        <Button color="danger" onClick={this.toggle}>{this.props.buttonLabel}</Button>
        <Modal isOpen={this.state.modal} toggle={this.toggle} className={this.props.className} size={propr.size ? prop.size : 'lg'}>
          <ModalHeader toggle={this.toggle}>Account Settings</ModalHeader>
          <ModalBody>
